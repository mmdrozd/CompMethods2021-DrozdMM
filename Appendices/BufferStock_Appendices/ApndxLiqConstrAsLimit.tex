...
\constr{\mathfrak{v}}_{T-1}^{\prime}(a)$.  Since the LHS of~\eqref{\localorexternallabel{eq:uPConstr}} and~\eqref{\localorexternallabel{eq:uPUnconstr}} are identical, this
