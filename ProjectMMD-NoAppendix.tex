...
\newcommand{\thankstext}{
This paper is based off the template for the Theoretical Foundations of Buffer Stock Theory by Chris D. Carroll. The repository for can be found here: \href{https://github.com/llorracc/BufferStockTheory}{Template}. The paper's results \href{https://\owner.github.io/nbreproduce}{can be automatically reproduced} using the \href{https://econ-ark/HARK}{Econ-ARK/HARK} toolkit, which can be cited per our references (\cite{carroll_et_al-proc-scipy-2018}); for reference to the toolkit itself see \href{https://econ-ark.org/acknowledging/}. All errors are my own.}
