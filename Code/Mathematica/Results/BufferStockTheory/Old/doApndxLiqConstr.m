...
,Graphics[Text["\!\(\*OverscriptBox[\(\[ScriptC]\), \(\[EmptySmallCircle]\)]\)(\[ScriptM]) \[LowerRightArrow]",{0.8mMaxPlot,\[ScriptC]\[EmptySmallCircle][0.8 mMaxPlot]},{1,-1}]]
]
];
...
Plot[{KinkPointsFunc'[\[ScriptB]],\[Kappa]MinInf},{\[ScriptB],b\[Sharp][nMin],b\[Sharp][nMax]},PlotRange->All]
